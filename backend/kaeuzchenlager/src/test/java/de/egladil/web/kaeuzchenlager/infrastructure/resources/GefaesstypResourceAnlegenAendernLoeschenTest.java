...
public class GefaesstypResourceAnlegenAendernLoeschenTest {
  ...
  @Inject StartupListener startupListener;

  @BeforeEach
  void before() {

    System.out.println(
        "============ GefaesstypResourceAnlegenAendernLoeschenTest =========================================");
  ...
  void should_anlegen_work() {
    ...
    // act
    final GefaesstypDto gefaesstypDto =
        given()
  ...
  void should_aendern_work() {
    ...
    final Optional<Gefaesstyp> optEntity =
    ...
    final GefaesstypDto gefaesstypUpdated =
        given()
            .header("API-Version", 1)
            .contentType(ContentType.JSON)
            .body(daten)
  ...
  void should_loeschen_work() {
    ...
    // act 3
    final GefaesstypLoeschenResult gefaesstypLoeschenResult =
        given()
            .header("API-Version", 1)
            .delete(uuid)
            .then()
