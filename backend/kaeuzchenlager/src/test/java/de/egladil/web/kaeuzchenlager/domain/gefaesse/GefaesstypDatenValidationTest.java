...
public class GefaesstypDatenValidationTest {
  ...
  class ValidDtoTests {
    ...
    void shouldPass_when_valid() {
      ...
      // act
      final Set<ConstraintViolation<GefaesstypDaten>> constraintViolations =
  ...
  class NameTests {
    ...
    void shouldNotPass_when_name_invalid() {
      ...
      assertAll(
          () ->
              assertEquals(
                  "name enthält ungültige Zeichen. Erlaubt sind Buchstaben, Ziffern, Leerzeichen, und die Sonderzeichen ( ) , ; _ - \" . : Wenn das nicht ausreicht, bitte an die Entwicklung wenden.",
                  cv.getMessage()),
    ...
    void shouldNotPass_when_name_blank() {
      ...
      ConstraintViolation<GefaesstypDaten> cv = constraintViolations.iterator().next();
      assertAll(
          () -> assertEquals("name ist erforderlich.", cv.getMessage()),
          () -> assertEquals("name", cv.getPropertyPath().toString()));
    }
    ...
    void shouldNotPass_when_name_null() {
      ...
      // arrange
      GefaesstypDaten dto =
          GefaesstypDaten.builder().volumen(200).anzahl(13).backgroundColor("#ffffff").build();
    ...
    void shouldNotPass_when_name_tooLong() {
      ...
      ConstraintViolation<GefaesstypDaten> cv = constraintViolations.iterator().next();
      assertAll(
          () -> assertEquals("name ist zu lang (max. 100 Zeichen).", cv.getMessage()),
          () -> assertEquals("name", cv.getPropertyPath().toString()));
    }
  }
  ...
  class VolumenTests {
    ...
    void shouldNotPass_when_volumenNull() {
      ...
      ConstraintViolation<GefaesstypDaten> cv = constraintViolations.iterator().next();
      assertAll(
          () -> assertEquals("volumen ist erforderlich.", cv.getMessage()),
    ...
    void shouldNotPass_when_volumen_lessThan0() {
      ...
      ConstraintViolation<GefaesstypDaten> cv = constraintViolations.iterator().next();
      assertAll(
          () -> assertEquals("volumen muss mindestens 1 sein.", cv.getMessage()),
          () -> assertEquals("volumen", cv.getPropertyPath().toString()));
    }
    ...
    void shouldNotPass_when_volumen_10000() {
      ...
      ConstraintViolation<GefaesstypDaten> cv = constraintViolations.iterator().next();
      assertAll(
          () -> assertEquals("volumen darf höchstens 9999 sein.", cv.getMessage()),
          () -> assertEquals("volumen", cv.getPropertyPath().toString()));
    }
  }
  ...
  class AnzahlTests {
    ...
    void shouldNotPass_when_negativ() {
      ...
      ConstraintViolation<GefaesstypDaten> cv = constraintViolations.iterator().next();
      assertAll(
          () -> assertEquals("anzahl darf nicht kleiner als 0 sein.", cv.getMessage()),
  ...
  class BackgroundColorTests {
    ...
    void shouldNotPass_when_backgroundColorInvalid() {
      ...
      ConstraintViolation<GefaesstypDaten> cv = constraintViolations.iterator().next();
      assertAll(
          () -> assertEquals("backgroundColor muss ein hex-Farbcode sein.", cv.getMessage()),
    ...
    void shouldNotPass_when_backgroundColorNull() {
      // arrange
      GefaesstypDaten dto =
          GefaesstypDaten.builder().name("Gefäßtyp 4").volumen(100).anzahl(22).build();
      ...
      ConstraintViolation<GefaesstypDaten> cv = constraintViolations.iterator().next();
      assertAll(
          () -> assertEquals("backgroundColor ist erforderlich.", cv.getMessage()),
          () -> assertEquals("backgroundColor", cv.getPropertyPath().toString()));
    }
  }
}
