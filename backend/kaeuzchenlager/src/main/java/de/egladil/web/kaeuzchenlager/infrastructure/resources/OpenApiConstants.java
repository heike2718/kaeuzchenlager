...
public final class OpenApiConstants {
    ...
    public static final String API_VERSION_MF = "API-Version wird nicht unterstützt. Bitte Header API-Version prüfen."
    ...
    public static final String NOT_AUTHORIZED_DESC = "nur authentifizierte und autorisierte User dürfen diese API aufrufen";
    ...
    public static final String NOT_ACCEPTABLE_DESC = "die im API-Version-Header genannte Version wird nicht unterstützt";
    ...
    public static final String PRECONDITION_FAILED_DESC = "das Ergebnis würde zu einer constraint violation führen (gleicher Name, gleiches Volumen=";
