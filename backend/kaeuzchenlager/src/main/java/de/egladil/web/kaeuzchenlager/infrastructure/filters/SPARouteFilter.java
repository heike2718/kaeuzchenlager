...
public class SPARouteFilter {
    ...
    private static final String APP_PLUS_API_PREFIX = "/kaeuzchenlager" + API_PREFIX;

    private static final String DEFAULT_APP = "/kaeuzchenlager/";
        ...
        if (path.startsWith(APP_PLUS_API_PREFIX)) {
            ...
            if (this.doesNotNeedRedirect(path)) {
                ...
                if (path.startsWith(DEFAULT_APP)) {
                    ...
                    // I0094: deep-Angular-Router-Links (z.B. /kaeuzchenlager/aufgabensammlungen/)
                    // müssen zur SPA Grund-URL
                    // (/kaeuzchenlager/) umgeleitet werden. Danach übernimmt wieder das
                    // Angular-Routing
    ...
    boolean doesNotNeedRedirect(final String path) {
        ...
        if (FILE_NAME_PREDICATE.test(path)) {
            ...
            LOGGER
                    .debug("(3-2) kein Umleiten von statischen files aus src/main/resources/META-INF/resources/kaeuzchenlager/");
            return true;
        }
