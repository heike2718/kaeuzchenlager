...
public class GefaesstypenResource {
    ...
    private static final String PRECONDITION_FAILED_DESC = "Gefäßtyp zwischenzeitlich durch jemand anderen geändert";
    ...
    public Response loadGefaesstypen(@HeaderParam(OpenApiConstants.HEADER_API_VERSION) final int apiVersion) {
        ...
        if (apiVersion != INT_1) {
            throw new UnsupportedVersionException(MessageFormat.format(OpenApiConstants.API_VERSION_MF, STRING_1));
        }
    ...
    public Response getGefaesstypWithId(@HeaderParam(OpenApiConstants.HEADER_API_VERSION) final int apiVersion,
            @PathParam("uuid") @Pattern(
                    ...
                    message = "uuid ist keine UUID.") final String uuid) {
    ...
    @Parameters({ @Parameter(
            ...
            name = OpenApiConstants.HEADER_API_VERSION,
            description = OpenApiConstants.HEADER_API_VERSION_DESCRIPTION), })
    @APIResponse(name = OpenApiConstants.OK_OUTCOME, responseCode = OpenApiConstants.NO_CONTENT_STATUS)
    @APIResponse(
            name = OpenApiConstants.BAD_REQUEST_ERROR,
            responseCode = OpenApiConstants.BAD_REQUEST_STATUS,
            description = OpenApiConstants.BAD_REQUEST_DESC,
