...
public final class HighLevelErrorClassifier {
    ...
    /**
     * Klassifiziert die gegebene Exception, um die, bei denen der Aufrufer
     * sinnvolle Aktionen machen kann, von denen trennen zu können, die
     * weitergewirfen werden müssen.
     *
    ...
    public static ErrorClassification classify(final Throwable throwable) {
        ...
        final Optional<OptimisticLockException> optLockException = ExceptionUtil
                .unwrap(throwable, OptimisticLockException.class);
        ...
        final Optional<ConstraintViolationException> optCve = ExceptionUtil
                .unwrap(throwable, ConstraintViolationException.class);
        if (optCve.isPresent()) {
        ...
        final Optional<SQLException> optSqlException = ExceptionUtil.unwrap(throwable, SQLException.class);
