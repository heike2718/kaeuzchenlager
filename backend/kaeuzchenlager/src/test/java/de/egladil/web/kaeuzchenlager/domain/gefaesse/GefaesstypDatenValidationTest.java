...
public class GefaesstypDatenValidationTest {
    ...
    class ValidDtoTests {
        ...
        void shouldPass_when_valid() {
            ...
            // arrange
            GefaesstypDaten dto = GefaesstypDaten
                    .builder()
                    .name("Gefäßtyp 4")
                    .volumen(200)
                    .anzahl(13)
    ...
    class NameTests {
        ...
        void shouldNotPass_when_name_invalid() {
            ...
            assertAll(() -> assertEquals(
                    ...
                    cv.getMessage()), () -> assertEquals("name", cv.getPropertyPath().toString()));
        }
        ...
        void shouldNotPass_when_name_null() {
            ...
            // arrange
            GefaesstypDaten dto = GefaesstypDaten.builder().volumen(200).anzahl(13).backgroundColor("#ffffff").build();
    ...
    class BackgroundColorTests {
        ...
        void shouldNotPass_when_backgroundColorNull() {
            // arrange
            GefaesstypDaten dto = GefaesstypDaten.builder().name("Gefäßtyp 4").volumen(100).anzahl(22).build();
