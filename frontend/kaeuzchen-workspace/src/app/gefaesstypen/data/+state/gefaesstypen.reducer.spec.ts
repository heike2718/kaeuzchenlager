...
import { createInitialGefaesstyp, Gefaesstyp, GefaesstypConflict, GefaesstypError } from '@gefaesstypen/model';
...
describe('gefaesstypenFeature', () => {
    ...
    describe('resetGefaesstypenState', () => {
        it('should return the initial state when actual state undefined', () => {
            const state = gefaesstypenFeature.reducer(undefined, gefaesstypenActions.resetGefaesstypenState);
            expect(state).toEqual(initialState);
        });
        it('should return the initial and a new reference when actual state defined (immutability)', () => {
            const state = gefaesstypenFeature.reducer(previousState, gefaesstypenActions.resetGefaesstypenState);
            expect(state).toEqual(initialState);
