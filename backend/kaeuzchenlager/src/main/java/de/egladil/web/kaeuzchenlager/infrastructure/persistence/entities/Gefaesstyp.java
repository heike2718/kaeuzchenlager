...
@NamedQueries({ @NamedQuery(name = Gefaesstyp.LOAD_ALL, query = "select g from Gefaesstyp g order by g.name asc"),
        @NamedQuery(
...
public class Gefaesstyp {
    ...
    // Hinweis: Die deutsche Sortierung kommt aus der DB-Collation
    // (utf8mb4_german2_ci am
    // Spalten-Datentyp).
    @Column(name = "name")
    private String name;
