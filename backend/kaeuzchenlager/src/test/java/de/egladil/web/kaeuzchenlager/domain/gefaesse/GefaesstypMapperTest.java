...
public class GefaesstypMapperTest {
    ...
    void should_toDtoMappAllAttributes() {
        ...
        // assert
        assertAll(() -> assertEquals("eb274a6b-8fff-4ee2-8471-80c14cd42323", dto.getUuid()), () -> assertNotNull(daten),
                () -> assertEquals("Gefäßtyp 2", daten.getName()), () -> assertEquals(13, daten.getAnzahl()),
                () -> assertEquals(200, daten.getVolumen()), () -> assertEquals("#ff00ff", daten.getBackgroundColor()));
    }
    ...
    void should_updateEntityFromDto_mapOnlyDaten() {
        ...
        // assert
        assertAll(() -> assertNull(entity.getUuid()), () -> assertEquals("Gefäßtyp 2", entity.getName()),
                () -> assertEquals(13, entity.getAnzahl()), () -> assertEquals(200, entity.getVolumen()),
                () -> assertEquals("#ff00ff", entity.getBackgroundColor()), () -> assertNull(entity.getCreatedAt()),
                () -> assertNull(entity.getCreatedBy()), () -> assertNull(entity.getUpdatedAt()),
