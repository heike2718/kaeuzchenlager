...
public class GefaesstypenResource {
  ...
  @Parameters({
    @Parameter(
        ...
        name = "API-Version",
        description = "Version dieser API. Default = 1"),
  })
  @APIResponse(
      name = "OKResponse",
      responseCode = "200",
  ...
  @APIResponse(
      name = "NotAuthorized",
      responseCode = "401",
      description = "nur autorisierte User dürfen diese API aufrufen",
      content = @Content(mediaType = "application/json"))
  @APIResponse(
      name = "NotAcceptable",
      responseCode = "406",
      description = "die im API-Version-Header genannte Version wird nicht unterstützt",
      content =
          @Content(
              mediaType = "application/json",
  ...
  @APIResponse(
      name = "BadRequest",
      responseCode = "400",
      description = "Payload besteht die Input-Validierung nicht",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ErrorResponseDto.class)))
  ...
  public Response gefaesstypAnlegen(
      @HeaderParam("API-Version") @DefaultValue("1") int apiVersion, @Valid GefaesstypDaten daten) {
  ...
  @APIResponse(
      name = "BadRequest",
      responseCode = "400",
      description = "Payload oder Path-Parameter bestehen die Input-Validierung nicht",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ErrorResponseDto.class)))
  ...
  @APIResponse(
      ...
      responseCode = "405",
      description = "wenn die uuid im path fehlt",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ErrorResponseDto.class)))
  ...
  @APIResponse(
      name = "Conflict",
      responseCode = "409",
      description = "Gefäßtyp ist bereits vorhanden (UC verletzt)",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ErrorResponseDto.class)))
  @APIResponse(
      ...
      responseCode = "412",
      description = "Gefäßtyp zwischenzeitlich durch jemand anderen geändert",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ErrorResponseDto.class)))
  ...
  @APIResponse(
      name = "BadRequest",
      responseCode = "400",
      description = "Path-Parameter besteht die Input-Validierung nicht",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ErrorResponseDto.class)))
